...
const AnimatedTestimonialCardWrapper = styled(Box, {
  shouldForwardProp: prop => prop !== 'cardPosition',
})<{ cardPosition: string }>(({ cardPosition, theme }) => ({
...
const StyledName = styled(Typography, { shouldForwardProp: prop => prop !== 'cardPosition' })<{
  cardPosition: string;
}>(({ cardPosition, theme }) => ({
...
const StyledRole = styled(Typography, { shouldForwardProp: prop => prop !== 'cardPosition' })<{
  cardPosition: string;
}>(({ cardPosition, theme }) => ({
