...
// Define proper types for Image component props
...
const meta: Meta<typeof DecorativeElements> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Decorative elements for the login page including the Omni logo, character illustrations, and background sketch. These elements are positioned absolutely to create an engaging and visually appealing login experience.',
      },
    },
  },
  tags: ['autodocs'],
...
export const Default: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'All decorative elements positioned as they appear on the login page. Includes logo, character illustrations, background sketch, and various decorative images.',
      },
    },
  },
};
...
export const BackgroundElementsOnly: Story = {
  render: renderBackgroundElements,
  parameters: {
    docs: {
      description: {
...
export const SmallElementsOnly: Story = {
  render: renderSmallElements,
  parameters: {
    docs: {
      description: {
        story:
          'Only the smaller decorative elements: magnifying glass, "Looking For" text, and star.',
      },
    },
  },
};
...
export const Mobile: Story = {
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Decorative elements optimized for mobile viewport (iPhone 6). Notice how elements scale and reposition.',
      },
    },
  },
};
...
export const Tablet: Story = {
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Decorative elements on tablet viewport (iPad). Shows medium-sized responsive behavior.',
      },
    },
  },
};
...
// Helper function to render element labels
const renderElementLabel = (text: string, color: string) => (
  <div
    style={{
      position: 'absolute',
      top: '-30px',
...
const renderLayerVisualization = () => (
  <>
    ...
    >
      ...
      />
      {renderElementLabel('Z-INDEX: 1', 'red')}
    </div>
    ...
    >
      <MockImage src="/assets/images/LogIn/rachel.png" alt="Rachel" width={209} height={97} />
      {renderElementLabel('Z-INDEX: 2', 'blue')}
    </div>
    ...
    >
      <MockImage src="/assets/images/LogIn/logo.png" alt="Omni Logo" width={105} height={30} />
      {renderElementLabel('Z-INDEX: 10', 'green')}
    </div>
  </>
);
...
export const LayerVisualization: Story = {
  render: renderLayerVisualization,
  parameters: {
    docs: {
      description: {
        story:
          'Visualization of the layering system with z-index values highlighted. Shows which elements stack above others.',
      },
    },
  },
};
...
export const AnimationDemo: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Decorative elements with subtle animations (floating effect). This demonstrates how the elements could be enhanced with motion.',
      },
    },
  },
};
...
export const HighContrast: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'High contrast version for accessibility testing. Shows how decorative elements appear with enhanced contrast.',
      },
    },
  },
};
